...
global $post;
$tmp_post = $post;
$myposts = get_posts('posts_per_page=9&order=DESC&orderby='.$orderOption.'&post_type=portfolio');
if( !empty($myposts) ): ?>

<ul class="recent-work jcarousel-skin-work">
...
<div class="home-block-title">
	<span></span>
	<h2><?php if( of_get_option('recent_work_label') ) echo of_get_option('recent_work_label'); ?></h2>
</div>
