...
<article id="post-<?php the_ID();?>" <?php post_class('entry-wrap');?>>
	<div class="format-content">
		<div class="shadow">
			<?php if( is_single() ): ?>
			<h1 class="postTitle"><a href="<?php echo $linkURL; ?>" target="_blank"><?php the_title(); ?> <?php _e('[Link]', 'premitheme');?></a></h1>
			<?php else: ?>
			<h2 class="postTitle"><a href="<?php echo $linkURL; ?>" target="_blank"><?php the_title(); ?> <?php _e('[Link]', 'premitheme');?></a></h2>
			<?php endif; ?>
		</div>
	</div>
